...
$packages = [
        ...
        ['name' => 'Laravel IDE Helper Generator', 'url' => 'https://github.com/barryvdh/laravel-ide-helper'],
        ['name' => 'DOMPDF Wrapper for Laravel', 'url' => 'https://github.com/barryvdh/laravel-dompdf'],
        ['name' => 'Intervention Image', 'url' => 'http://image.intervention.io/getting_started/installation#laravel']
];
?>
<!doctype html>
<html lang="de">
...
<div class="container">
    <div class="row">
        <div class="column">
            <table>
                ...
                <tr>
                    <td colspan="2"><h3>Server-Requirements Checker</h3></td>
                </tr>
            </table>
        </div>
    </div>
    <div class="row">
            ...
            <dl>
                ...
                <dd>PHP >= 7.2.5
                    ...
                    if(version_compare(phpversion(), '7.2.5', '>')) {
                        echo '&nbsp;&nbsp;';
                        echo '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                        ...
                        echo phpversion();
                        echo '&nbsp;&nbsp;';
                        echo '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 352 512">
                ...
                foreach ($requirements as $requirement) {
                    ...
                    echo '<dd>';
                    echo $requirement . ' PHP Extension';
                    echo '&nbsp;&nbsp;';
        ...
        <div class="column">
            <dl>
                <dt>Laravel Packages</dt>
                <?php
                foreach($packages as $package) {
                    echo '<dd><a class="button button-clear" target="_blank" href="'.$package['url'].'">'.$package['name'].'</a></dd>';
                }
                ?>
            </dl>
        </div>
    ...
    <div class="row">
        <div class="column">
            <p style="text-align: center">
                ...
                <a href="https://milligram.io/" target="_blank">Milligram CSS Framework</a>
            </p>
        </div>
    </div>
</div>
