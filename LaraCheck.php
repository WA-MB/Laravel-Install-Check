...
$packages = [
        ['name' => 'Media Uploader', 'url' => 'https://github.com/ahmed-aliraqi/laravel-media-uploader', 'composer' => 'ahmed-aliraqi/laravel-media-uploader'],
        ...
        ['name' => 'Schematics', 'url' => 'https://github.com/mtolhuys/laravel-schematics', 'composer' => 'mtolhuys/laravel-schematics'],
        ['name' => 'Livewire', 'url' => 'https://laravel-livewire.com/docs/quickstart', 'composer' => 'livewire/livewire'],
        ['name' => 'Boilerplate', 'url' => 'https://laravel-boilerplate.com/', 'composer' => '']
];
    ...
    <div class="row">
        <div class="column">
            <table>
                ...
                <tr>
                  <td colspan="2"><pre><code>composer global require laravel/installer</code></pre></td>
                </tr>
            </table>
        </div>
    </div>
